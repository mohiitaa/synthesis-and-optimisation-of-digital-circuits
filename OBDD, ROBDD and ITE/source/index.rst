.. SDC Project 1 documentation master file, created by
   sphinx-quickstart on Sun Nov 05 08:29:44 2017.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to SDC Project 1's documentation!
###########################################
.. toctree::
   :maxdepth: 2
   :caption: Contents:
...
Code for OBDD, ROBDD and ite
============================
NOTE : The code also does ERROR HANDLING
****************************************
* Enter the function
* If you want to quit press "q", else specify the splitting order
* If you didn't quit,output(OBDD leaf node values,ROBDD tree and ITE expression) appears for the given splittng order.
* Go to step 2.
...
* All null cubes.
* A tautology.
* PCN=[['01','01','01'],['10','01','01']]-->gives an asymmetric tree
* PCN=[['01','01','01'],['10','10','10']]-->gives a symmetric tree
* PCN=[['01','11','11']]-->Function dependent on a single variable
